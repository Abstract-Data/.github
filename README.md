# Abstract Data Organization Profile Repository
...
- `scripts/` – utilities for generating dynamic content
- `.github/workflows/` – automation to refresh profile assets

For contribution details, see `profile/CONTRIBUTING.md`.
